const Search = () => {
  const viewSearch = `      
    <div class="container">
      ...
      <div class="caja2">
        <div class="search">
          <div class="perfil"><img class="imgPerfil" src="AvatarA1.png" alt=""></div>
          <div class="caracteres">
            <div class="nombre">JUANITO ARISTISABAL</div>
            <div class="pais">Perú</div>
            <div class="intereses">
              <div class="imgCaracteres"><img src="AguaCN.png" alt=""></div>
              <div class="imgCaracteres"><img src="AnimalCN.png" alt=""></div>
              <div class="imgCaracteres"><img src="AnimalCN.png" alt=""></div>
            </div>
          </div>  
        </div>
        <div class="search">
          <div class="perfil"><img class="imgPerfil" src="AvatarA3.png" alt=""></div>
          <div class="caracteres">
        ...
        <div class="search">
          <div class="perfil"><img class="imgPerfil" src="AvatarA5.png" alt=""></div>
          <div class="caracteres">
        ...
        <div class="search">   <div class="perfil"><img class="imgPerfil" src="AvatarA3.png" alt=""></div>
          <div class="caracteres">
        ...
        <div class="search">   <div class="perfil"><img class="imgPerfil" src="AvatarA6.png" alt=""></div>
          <div class="caracteres">
        ...
        <div class="search">   <div class="perfil"><img class="imgPerfil" src="AvatarA9.png" alt=""></div>
          <div class="caracteres">
        ...
        <div class="search">   <div class="perfil"><img class="imgPerfil" src="AvatarA8.png" alt=""></div>
          <div class="caracteres">
